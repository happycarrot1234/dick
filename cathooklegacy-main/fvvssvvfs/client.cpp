...
void Client::ClanTag()
{
	...
	if (g_menu.main.misc.clantag.get()) {
		...
		if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.6) % 18) {
			...
			case 2: {  SetClanTag("ca"); break; }
			case 3: {  SetClanTag("cat"); break; }
			case 4: {  SetClanTag("cath"); break; }
			case 5: {  SetClanTag("catho"); break; }
			case 6: {  SetClanTag("cathoo"); break; }
			case 7: {  SetClanTag("cathook"); break; }
			case 8: {  SetClanTag("cathook."); break; }
			case 9: {  SetClanTag("cathook.p"); break; }
			case 10: { SetClanTag("cathook.pu"); break; }
			case 11: { SetClanTag("cathook.pub"); break; }
			case 12: { SetClanTag("cathook.pub"); break; }
			case 13: { SetClanTag("cathook.pub"); break; }
			case 14: { SetClanTag("cathook.pu"); break; }
			case 15: { SetClanTag("cathook.p"); break; }
			case 16: { SetClanTag("cathook."); break; }
			case 17: { SetClanTag("cathook"); break; }
			case 18: { SetClanTag("cathoo"); break; }
			case 19: { SetClanTag("catho"); break; }
			case 20: { SetClanTag("cath"); break; }
			case 21: { SetClanTag("cat"); break; }
			case 22: { SetClanTag("ca"); break; }
			case 23: { SetClanTag("c"); break; }
			case 24: { SetClanTag(""); break; }
			default:;
			}
...
void Client::print(const std::string text, ...) {
	...
	// print to console.
	g_csgo.m_cvar->ConsoleColorPrintf(g_gui.m_color, XOR("[cat] "));

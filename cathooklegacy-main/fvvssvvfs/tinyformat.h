...
// * C++98 cfgport, with optional C++11 niceties
//
//
...
// of printf() for cfger simple logging.
//
//
...
// format strings which are uncfgported or have the wrong number of format
...
// general.  If you don't define this, C++11 cfgport is autodetected below.
...
#       endif
        ...
        template<typename T> struct is_wchar { typedef int tinyformat_wchar_is_not_cfgported; };
...
#undef TINYFORMAT_DEFINE_FORMAT_TRUNCATED_CSTR
        ...
        const char *fmtEnd, int ntrunc, const T &value )
    {
        ...
        // Since we don't cfgport printing of wchar_t using "%ls", make it fail at
        // compile time in preference to printing as a void* at runtime.
        typedef typename detail::is_wchar<T>::tinyformat_wchar_is_not_cfgported DummyType;
        ( void )DummyType( ); // avoid unused type warning with gcc-4.8
#endif
    // The mess here is to cfgport the %c and %p conversions: if these
    ...
    // Overloaded version for char types to cfgport printing as an integer
...
#           endif
            ...
            case 's':
                ...
                break;
            case 'n':
                // Not cfgported - will cause problems!
                TINYFORMAT_ERROR( "tinyformat: %n conversion spec not cfgported" );
                break;
            case '\0':
            ...
            if ( intConversion && precisionSet && !widthSet ) {
                ...
                // padded with zeros on the left).  This isn't really cfgported by the
